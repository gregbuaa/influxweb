...
for(var i = 0; i < common_css_files.length; i++){
	document.write("<link rel='stylesheet' type='text/css' href='/static/bootstrap-3.3.7/"+common_css_files[i]+"'>");
}
/**
 * 导入JS文件
 */
for(var i = 0; i < common_js_files.length; i++){
	document.write("<script type='text/javascript' src='/static/bootstrap-3.3.7/"+common_js_files[i]+"'></script>");
}
